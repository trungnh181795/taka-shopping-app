...
const envVarsSchema = Joi.object()
  .keys({
    ...
    TWILIO_SID: Joi.string().description('Account SID from www.twilio.com/console'),
    TWILIO_TOKEN: Joi.string().description('Auth Token from www.twilio.com/console'),
    TWILIO_SERVICE_ID: Joi.string().description('Service ID from www.twilio.com/console'),
    PHONE_FROM: Joi.string().description('default number phone of sender'),
    CLOUD_NAME: Joi.string().description('cloud name from cloudinary'),
    CLOUD_API_KEY: Joi.string().description('cloud api key from cloudinary'),
    CLOUD_API_SECRET: Joi.string().description('cloud api secret from cloudinary'),
  })
  .unknown();
